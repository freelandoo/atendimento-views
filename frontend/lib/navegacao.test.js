...
test('a area de Equipe e' + "'" + ' de gestao: comercial NAO ve o item', () => {
...
test('GUARDA: "Equipes comerciais" nao volta como item separado', () => {
  // As duas telas eram partes do MESMO fluxo, com a MESMA capacidade, e foram unificadas em
  // `/dashboard/equipe` (aba "Equipes") em 2026-09-19. Recriar o item aqui devolveria a viagem
  // no meio do trabalho — e apontaria para uma rota que nao existe mais.
  assert.ok(!hrefs(itensVisiveis(superadmin)).includes('/dashboard/equipes-comerciais'))
})
