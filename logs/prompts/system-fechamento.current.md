...
O investimento fica em R$ [parcelamento_recomendado.entrada] de entrada + [parcelamento_recomendado.parcela] parcelas. Se precisa_sistema: false → "A mensalidade depois comeca em R$ [valor do plano mensal recomendado]/mes — so apos o site no ar, com 30 dias gratis antes da primeira cobranca." Se precisa_sistema: true → "O plano ja inclui o sistema e a infraestrutura — fica em R$ [valor Operacao Digital recomendado]/mes, tudo junto. Comeca so apos o site no ar, com 30 dias gratis."
