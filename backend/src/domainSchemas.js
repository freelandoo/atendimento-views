...
function normalizarProspectPersistido(row) {
  ...
  return {
    ...
    categoria,
    categoria_perfil: row.categoria_perfil || '',
    bio: row.bio || '',
    ...
    anuncio_meta_ativo: row.anuncio_meta_ativo == null ? null : row.anuncio_meta_ativo === true,
    anuncio_meta_inicio_em: row.anuncio_meta_inicio_em || null,
    anuncio_meta_page_id: row.anuncio_meta_page_id || '',
    anuncio_meta_verificado_em: row.anuncio_meta_verificado_em || null,
    anuncio_meta_pagina_verificada_em: row.anuncio_meta_pagina_verificada_em || null,
